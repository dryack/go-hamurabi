...
func orientation() {
	...
	enterToCont()
	fmt.Println("Each year I will present you with an accounting of our prior year's incomes and expenditures. " +
	...
	enterToCont()
	fmt.Println("Acres may be purchased from land-owning peasants at a price which varies each year. \nOur people may " +
	...
	enterToCont()
	fmt.Println("You must know that starvation; whether caused by cruelty plague, or pest, will eventually" +
